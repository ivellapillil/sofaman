...
class TestSofaParser:
    ...
    def test_parse_package_variations(self, parser):
        self.assert_variation(parser, test_cases.test_variations.package_variations())
    ...
    def test_parse_diagram_variations(self, parser):
        self.assert_variation(parser, test_cases.test_variations.diagram_variations())

    def test_parse_stereotype_variations(self, parser):
        self.assert_variation(parser, test_cases.test_variations.stereotype_variations())

    def test_parse_actor_variations(self, parser):
        self.assert_variation(parser, test_cases.test_variations.actor_variations())

    def test_parse_component_variations(self, parser):
        self.assert_variation(parser, test_cases.test_variations.component_variations())

    def test_parse_relation_variations(self, parser):
        self.assert_variation(parser, test_cases.test_variations.relation_variations())

    def test_parse_primitives_variations(self, parser):
        self.assert_variation(parser, test_cases.test_variations.primitives_variations())

    def test_parse_class_variations(self, parser):
        self.assert_variation(parser, test_cases.test_variations.class_variations())

    def test_parse_interface_variations(self, parser):
        self.assert_variation(parser, test_cases.test_variations.interface_variations())

    def test_parse_domain_variations(self, parser):
        self.assert_variation(parser, test_cases.test_variations.domain_variations())


    def test_parse_capability_variations(self, parser):
        self.assert_variation(parser, test_cases.test_variations.capability_variations())
